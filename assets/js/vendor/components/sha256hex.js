/**
 * Pure-JS SHA-256 (hex digest).
 *
 * Shared between the main-thread fallback and the proof-of-work Web Worker
 * so the hashing implementation lives in a single place.
 *
