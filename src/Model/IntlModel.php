...
final class IntlModel extends BaseModel
{
    ...
    public function __construct(
        ...
        public readonly ?string $introductionTitle = null,
        public readonly ?string $introduction = null,
        public readonly ?string $bodyTitle = null,
        public readonly ?string $body = null,
        public readonly ?string $bodyTitleSecond = null,
        public readonly ?string $bodySecond = null,
        ...
        public readonly ?string $advendisingTitle = null,
    ...
    public static function fromEntity(mixed $entity, CoreLocatorInterface $coreLocator, bool $query = true, array $options = []): self
    {
        ...
        $response = new self(
            ...
            introductionTitle: self::getContent('introductionTitle', $intl),
            introduction: self::escape($intro) ?: null,
            bodyTitle: self::getContent('bodyTitle', $intl),
            body: self::escape($body) ?: null,
            bodyTitleSecond: self::getContent('bodyTitleSecond', $intl),
            bodySecond: self::getContent('bodySecond', $intl),
            placeholder: self::getContent('placeholder', $intl),
            label: self::getContent('label', $intl),
            ...
            advendisingTitle: self::getContent('advendisingTitle', $intl),
