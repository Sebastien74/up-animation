...
{
    private const array IPS_DEV = ['::1', '127.0.0.1', 'fe80::1', '194.51.155.21', '195.135.16.88'];
    ...
    public function inBuild(Request $request, WebsiteModel $website, ConfigurationModel $configuration): bool|string
    {
        ...
        if ($inMaintenance && !$allowedIP && !$allowedPath) {
            ...
            return 'front_build_page' !== $request->attributes->get('_route') ? $this->coreLocator->router()->generate('front_build_page') : false;
        }
