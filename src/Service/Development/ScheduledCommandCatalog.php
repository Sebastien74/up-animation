...
final class ScheduledCommandCatalog
{
    ...
    public function all(): array
    {
        return [
            ...
            new ScheduledCommandDefinition('Analyse périodique des pages', 'app:analysis-page:run', '0 6 * * 1', 'Analyse en HTTP les pages publiées (perf & rendu) et historise les indices, tous les lundis à 6H', true),
        ];
    }
