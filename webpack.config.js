...
Encore.setOutputPath('public/build/front/default')
    ...
    .addEntry('front-default-home', ['./assets/js/front/default/templates/home.js', './assets/scss/front/default/templates/home.scss'])
    .addEntry('front-default-cms', ['./assets/js/front/default/templates/cms.js', './assets/scss/front/default/templates/cms.scss'])
    .addEntry('front-default-legacy', ['./assets/js/front/default/templates/legacy.js', './assets/scss/front/default/templates/legacy.scss'])
    .addEntry('front-default-security', ['./assets/js/front/default/templates/security.js', './assets/scss/front/default/templates/security.scss'])
    .addEntry('front-default-security-back', ['./assets/js/front/default/templates/security-back.js', './assets/scss/front/default/templates/security-back.scss'])
    .addEntry('front-default-catalog', ['./assets/js/front/default/templates/catalog.js', './assets/scss/front/default/templates/catalog.scss'])
    .addEntry('front-default-newscast', ['./assets/js/front/default/templates/newscast.js', './assets/scss/front/default/templates/newscast.scss'])
    .addEntry('front-default-build', ['./assets/js/front/default/templates/build.js', './assets/scss/front/default/templates/build.scss'])
    .addEntry('front-default-identification', './assets/js/front/default/templates/identification.js')
    .addEntry('front-default-switcher', ['./assets/js/front/default/templates/switcher.js', './assets/scss/front/default/templates/switcher.scss'])
    .addEntry('front-default-error', ['./assets/js/front/default/templates/error.js', './assets/scss/front/default/templates/error.scss'])
    ...
    .addStyleEntry('front-default', ['./assets/scss/front/default/themes/main.scss'])
    .cleanupOutputBeforeBuild()
    .enableVersioning(enableVersioning)
    .enableSourceMaps(enableSourceMaps)
    .enableIntegrityHashes(enableIntegrity)
...
Encore.setOutputPath('public/build/admin')
    ...
    .addEntry('admin-analysis-page', './assets/js/admin/pages/analysis-page-dashboard.js')
